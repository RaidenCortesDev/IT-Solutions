 ...
 * @param { string } mensajeDeAyuda mensaje de ayuda cuando el estado de
 *  elementoHtml es válido.
 */
export function muestraTextoDeAyuda(elementoHtml, elementoDeAyuda, mensajeDeAyuda) {
...
window["muestraTextoDeAyuda"] = muestraTextoDeAyuda;
